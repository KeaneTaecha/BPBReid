...
class PersonReID:
    def __init__(self, reid_model_path, hrnet_path):
        ...
        # Setup transforms to match BPBReID's exact testing pipeline
        self.transform = Compose([
            Resize(384, 128),  # Direct resize (height, width)
    ...
    def extract_features(self, image):
        """Extract ReID features using BPBReID's exact testing preprocessing"""
        
        # Ensure image is numpy array in RGB format
        ...
        # Apply BPBReID's exact testing transforms
